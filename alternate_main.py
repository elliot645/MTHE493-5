...
def run_experiment(start_year, end_year, timestep, voting_df, fips_dict, neighbours):
...
if __name__ == "__main__":
    ...
    # Get FIPS numbers
    fips_dict = get_fips_dict(voting_df)
    ...
    # # Run experiment 
    # results = run_experiment(start_year, end_year, timestep, voting_df, fips_dict, neighbours)
