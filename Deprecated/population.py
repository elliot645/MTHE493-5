...
db = pd.read_csv('data/county_pops_2020_to_2023.csv',encoding='latin1')
...
print(get_population_data(2020, 'Alabama', 'Autauga County'))

pd.DataFrame.from_dict(age_data).to_csv('age_data_baby!!')